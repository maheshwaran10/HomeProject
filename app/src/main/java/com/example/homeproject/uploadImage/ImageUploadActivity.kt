...
open class ImageUploadActivity : AppCompatActivity(), View.OnClickListener {
                ...
                override fun onResponse(call: Call<ServerResponse?>, response: Response<ServerResponse?>
                    ...
                    if (response.isSuccessful) {
                        if (response.body() != null) {
                            ...
                            Toast.makeText(applicationContext, "Response Successful", Toast.LENGTH_SHORT).show()
    ...
    companion object {
        ...
        private val TAG = ImageUploadActivity::class.java.getSimpleName()
